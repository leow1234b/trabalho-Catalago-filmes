...
<main class="container py-5">
    <div class="form-panel mx-auto">
        ...
        <form method="POST">
            ...
            <input class="form-control mb-3" id="nome" type="text" name="nome" minlength="3" maxlength="100" required>
            ...
            <button class="btn btn-danger w-100" type="submit">Cadastrar</button>
        </form>
